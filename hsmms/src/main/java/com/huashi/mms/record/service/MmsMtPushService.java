...
import com.huashi.mms.config.worker.fork.MtReportFailoverPushWorker;
            ...
            stringRedisTemplate.opsForList().rightPush(MmsRedisConstant.RED_QUEUE_MMS_DELIVER_FAILOVER,
                                                       JSON.toJSONString(failoverDeliversQueue,
                                                                         new SimplePropertyPreFilter("msgId", "mobile",
                                                                                                     ...
                                                                                                     "status",
                                                                                                     "createTime")));
            // stringRedisTemplate.expire(MmsRedisConstant.RED_MESSAGE_DELIVED_WAIT_PUSH_LIST, 5, TimeUnit.MINUTES);
        } catch (Exception e) {
