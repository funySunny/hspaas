...
public class SmsMtTaskForkService {
     ...
     * @return
     */
    public List<List<SmsMtTask>> distributeTasks(List<SmsMtTask> tasks, int threshold) {
        List<List<SmsMtTask>> distributeTasks = new ArrayList<>();
    ...
    public Future<ResponseMessage> parallelTaskApproved(List<SmsMtTask> tasks) {
        try {
     ...
     * @return
     */
    private ResponseMessage mulitiTaskApprove(List<SmsMtTask> tasks) {
        // 通道ID下的通道数据
     ...
     * @return
     */
    private boolean setTaskPacketsMessageTemplateExtNumber(SmsMtTaskPackets packets,
     ...
     * @param target
     */
    public void copyUserCustomProperties(SmsMtTask source, SmsMtTaskPackets target) {
     ...
     * @param packets
     */
    public void sendRejectPackageQueue(SmsMtTaskPackets packets) {
