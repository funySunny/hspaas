...
public interface IUserService {
     ...
     * @param pushConfigList 短信推送配置信息（下行报告和上行报告）
     * @param passageGroupId 通道组ID
     * @param userSmsConfig 短信基础配置信息
     * @return
     */
     ...
     * 
     * @param userId 用户ID
     * @param balance 流量余额（金额）
     * @param pushConfig 流量充值结果推送配置
     * @param userFluxDiscount 用户流量折扣信息
     * @return
     */
