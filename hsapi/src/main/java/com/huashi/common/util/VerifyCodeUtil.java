...
public class VerifyCodeUtil {
	...
	public static BufferedImage drawGraphic(String code){
		return drawGraphic(WIDTH, HEIGHT, code);
	}
	 ...
	 * @throws IOException
	 */
	public static BufferedImage drawGraphic(int w, int h, String code) {
	...
	public VerifyCodeUtil(int imgRandNumber) {
		if (imgRandNumber < 4) {
			imgRandNumber = 4;
		}
