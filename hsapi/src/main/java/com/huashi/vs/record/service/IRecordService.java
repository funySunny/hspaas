...
public interface IRecordService {
     ...
     * @param status      状态
     * @param type        类型（0语音验证码 1 语音通知）
     * @return
     */
    PaginationVo<Record> findPage(int userId, String phoneNumber, String startDate, String endDate, String currentPage, String status, String type);
