...
public class MessageSendUtil {
     ...
     * @return 返回发送之后收到的信息
     */
    public static SmsResponse sms(String url, String appkey, String password, String mobile, String content) {
     ...
     * @throws Exception
     */
    public static boolean smsWithStatus(String url, String appkey, String appsecret, String mobile, String content)
                                                                                                                   throws Exception {
        try {
