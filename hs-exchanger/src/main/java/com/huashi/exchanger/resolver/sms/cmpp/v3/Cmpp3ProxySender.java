package com.huashi.exchanger.resolver.sms.cmpp.v3;
...
@Component
public class Cmpp3ProxySender extends AbstractSmProxySender{
    ...
    public void mtDeliver(CMPP30DeliverMessage report) {
        ...
        try {
            ...
            response.setRemark(String.format("DestnationId:%s,ServiceId:%s", report.getDestnationId(),
                                             report.getServiceId()));
