package com.huashi.exchanger.resolver.sms.http.xinchi;
...
public class XinchiPassageResolver extends AbstractPassageResolver {
    ...
    /**
     * TODO 解析发送返回值 eg. {"errorCode": "", "overdue": false, "timeout": false, "message": "操作成功！", "success": true,
     * "serialNo": "101117122700000634" }
     * 
     * @param result
     * @param successCode
     * @return
