package com.huashi.exchanger.resolver.sms.sgip;
...
@Service
public class SgipProxySender extends AbstractSmProxySender {
    ...
    public void mtDeliver(SGIPReportMessage report) {
        ...
        try {
            ...
            response.setRemark(String.format("msg_id:%s,code:%d", report.getSubmitSequenceNumber() + "",
                                             report.getErrorCode()));
