...
public class SmsPassageStatusReportPullTask implements Runnable {
    ...
    public SmsPassageStatusReportPullTask(SmsPassageAccess smsPassageAccess, ISmsMtDeliverService smsMtDeliverService,
