...
<script type="text/javascript" src="${rc.contextPath}/assets/index.js"></script>
<script type="text/javascript" src="${rc.contextPath}/assets/echarts/echarts.min.js"></script>
