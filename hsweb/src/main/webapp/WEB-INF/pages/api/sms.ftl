...
<link href="${rc.contextPath}/static/css/api.css" rel="stylesheet" type="text/css" />
<link href="${rc.contextPath}/static/css/api_content.css" rel="stylesheet" type="text/css" />
</head>
<body>
