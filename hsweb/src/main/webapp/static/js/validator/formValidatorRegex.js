var regexEnum = {
	...
	zipcode : "^\\d{6}$", // 邮编
	mobile : "^(13[0-9]|15[012356789]|17[0678]|18[0-9]|14[57])[0-9]{8}$", // 手机
	...
	password : "^(?![\d]+$)(?![a-zA-Z]+$)(?![^\da-zA-Z]+$).{6,18}$", // 密码
...
function isIP(ip) {
	return ip
			.match(/^(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$/);
}