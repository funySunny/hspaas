...
<html>
  <head>
    ...
    <title>华时融合平台-登录</title>
    <link href="${BASE_PATH}/resources/css/bootstrap.css" rel="stylesheet">
    <link href="${BASE_PATH}/resources/css/signin.css?v=1112" rel="stylesheet">
  ...
  <body style="font-family:'微软雅黑'">
    <div class="container">
      <form class="form-signin" id="myform">
        <h2 class="form-signin-heading">华时融合平台@hspaas.cn </h2>
        	...
        	<input type="text" id="authCode" name="authCode" maxlength="4" style="width:60%;" class="form-control validate[required,maxSize[4]" placeholder="请输入验证码">
        	<img src="${BASE_PATH}/account/validate_code" title="点击刷新验证码" onclick="refash_validate();" id="validate_image">
        	
        	<label for="inputMfa" class="sr-only">动态口令</label>
        	<input type="text" id="mfa" name="mfa" class="form-control" placeholder="请输入动态口令">
        	
        	<button class="btn btn-lg btn-info btn-block" onclick="formLogin();" style="margin-top:10px" type="button">登&nbsp;&nbsp;&nbsp;录</button>
      </form>
    </div>
  </body>
