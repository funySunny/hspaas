...
<html lang="en">
                                ...
                                <form id="myform" class="form-horizontal">
                                  <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-5">
                                            <input type="text" class="form-control validate[required,maxSize[100]]" name="bossRole.role_name" id="role_name" placeholder="请输入角色名称">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label">描述</label>
                                        <div class="col-xs-5">
                                             <textarea class="form-control" name="bossRole.memo" id="memo" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
	...
	<script type="text/javascript">
		...
		function formSubmit(){
			...
			$.ajax({
	  			url:'${BASE_PATH}/boss/role/create',
	  			dataType:'json',
	  			data:$('#myform').serialize(),
	  			type:'post',
	  			success:function(data){
	  				if(data.result){
                        Boss.alertToCallback('新增角色成功！',function(){
