                    ...
                    <form id="myform" class="form-horizontal">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <select id="passageId" name="model.passageId" class="form-control" readonly="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" class="form-control validate[required,maxSize[10],custom[number],min[0]]"
                                           name="model.interval" id="interval" value="${model.showMinuteInterval}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" class="form-control validate[required,maxSize[10],custom[number],min[0]]"
                                           name="model.startTime" id="startTime" value="${model.showMinuteStartTime}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" class="form-control validate[required,maxSize[10],custom[number],min[0]]"
                                           name="model.timeLength" id="timeLength" value="${model.showMinuteTimeLength}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" class="form-control validate[required,maxSize[10],custom[number],min[1]]"
                                           name="model.countPoint" id="countPoint" value="${model.countPoint}"
                                           placeholder="请输入计数阀值"/>
                                </div>
                            </div>
                            <div class="form-group batchContent">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" class="form-control validate[required,maxSize[10],custom[number],min[1]]"
                                           name="model.rateThreshold" id="rateThreshold" value="${model.rateThreshold}"
                                           placeholder="请输入到达率">
                                </div>
                            ...
                            <div class="form-group batchContent">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" class="form-control validate[required]"
                                           name="model.mobile" id="mobile" value="${model.mobile}"
...
<script type="text/javascript">
    ...
    function formSubmit() {
        ...
        $.ajax({
            url: '${BASE_PATH}/monitor/reachrateSettings/update',
            dataType: 'json',
