                    ...
                    <form id="myform" class="form-horizontal">
                        <div class="panel-body">
                            ...
                            <div id="group_0" class="groupConfig">
                                ...
                                <#assign routeType = 0>
                                <#include "/WEB-INF/views/sms/passage_group/province_cmcp_table.ftl">
                                <#--<#include "/WEB-INF/views/sms/passage_group/groupItems.ftl">-->
                                <div class="form-group">
                                    <label class="col-xs-2 control-label">备注</label>
                                    <div class="col-xs-8">
                                        <textarea class="form-control" name="group.comments" id="comments" rows="5"></textarea>
                                    </div>
                                </div>
                            </div>
                            <#list routeTypes as r>
...
<script type="text/javascript">
    ...
    function formSubmit(){
        ...
        $.ajax({
            url:'${BASE_PATH}/sms/passage_group/create',
            dataType:'json',
            data:$('#myform').serialize(),
            type:'post',
            success:function(data){
                if(data.result){
                    Boss.alertToCallback('新增通道组成功！',function(){
