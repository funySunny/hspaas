            ...
            <div id="page-content">
                <div class="panel">
                    ...
                    <form id="myform" class="form-horizontal">
                    	 <input type="hidden" name="signatureExtNo.id" id="id" value="${(signatureExtNo.id)!}" />
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-xs-2 control-label">开户用户</label>
                                <div class="col-xs-4">
                                    <select id="userId" name="signatureExtNo.userId" class="form-control" readonly="readonly">
                                    <#if userList??>
                                        <#list userList as u>
                                            <option value="${u.userId!''}" <#if u.userId==signatureExtNo.userId>selected</#if>>${u.name!''}-${u.username!''}</option>
                                        </#list>
                                    </#if>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" class="form-control validate[required,maxSize[32]]" value="${(signatureExtNo.signature)!}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" class="form-control validate[required,maxSize[16]]"
                                           name="signatureExtNo.extNumber" id="extNumber" value="${(signatureExtNo.extNumber)!}"
                                           placeholder="请输入扩展号码">
                                </div>
                            </div>
                            <div class="form-group batchContent">
                                ...
                                <div class="col-xs-4">
                                    <textarea class="form-control" name="signatureExtNo.remark" rows="3">${(signatureExtNo.remark)!}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
	...
	function formSubmit(){
		...
		$.ajax({
  			url:'${BASE_PATH}/sms/signature_extno/update',
  			dataType:'json',
