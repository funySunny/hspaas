                    ...
                    <form id="myform" class="form-horizontal">
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-xs-5">
                                	<input type="hidden" name="forbiddenWords.id" id="id" value="${(forbiddenWords.id)!}">
                                	<input type="text" class="form-control validate[required,maxSize[32]]" readonly = "readonly" name="forbiddenWords.word" id="word" value="${(forbiddenWords.word)!}" placeholder="输入敏感词">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-5">
                                	<input type="text" class="form-control validate[required,maxSize[32]]"
                                           name="forbiddenWords.label" id="label" value="${(forbiddenWords.label)!}" placeholder="用于显示敏感词区分" />
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function formSubmit(){
        ...
        $.ajax({
            url:'${BASE_PATH}/sms/forbidden_word/update',
            dataType:'json',
            data:$('#myform').serialize(),
            type:'post',
            success:function(data){
                if(data.result){
                    Boss.alertToCallback('修改敏感成功！',function(){
