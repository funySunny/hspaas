...
<#include "/WEB-INF/views/main/top.ftl">
    <div class="boxed">
        ...
        <div id="content-container">
            ...
            <#--value="${keyword!''}" placeholder="输入内容/手机号/接口帐号">-->
            <#--</div>-->
            <#--</div>-->
            <#--<div class="col-md-4">-->
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <#if pl.isTemplateError()>
                                        <a href="${BASE_PATH }/sms/message_template/create?sid=${pl.sid}&taskId=${pl.id}"
                                           class="btn btn-success btn-xs">模板报备</a>
                                    </#if>
                                    <#if pl.isWordError()>
                                        <a  href="${BASE_PATH }/sms/message_template/edit?id=${pl.messageTemplateId}&sid=${pl.sid}&taskId=${pl.id}"
                            ...
                            <tr>
                                <td colspan="8" align="right" style="word-break:break-all;">
                                    ${pl.content!''}
                                </td>
                            </tr>
                            </#list>
