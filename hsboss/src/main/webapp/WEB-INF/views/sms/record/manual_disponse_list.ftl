                    ...
                    <div class="panel-body">
                        <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0);" class="btn btn-danger btn-xs" onclick="">重发</a>
                                    &nbsp;
                                    <a href="javascript:void(0);" class="btn btn-default btn-xs" onclick="">丢弃</a>
                                </td>
                            </tr>
                            <tr>
...
<script type="text/javascript">
    function jumpPage(p){
        $('#pn').val(p);
        $('#myform').attr('action','${BASE_PATH}/sms/record/manual_disponse_list');
        $('#myform').submit();
    }
