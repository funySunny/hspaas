                        ...
                        <div class="panel-body">
                           ...
                           <div class="form-group">
							...
							<div class="form-group">
                                ...
                                <div class="col-xs-5">
                                    <input type="text" class="form-control validate[required,maxSize[100],custom[number],min[1]]" name="smsPriorityWords.priority" id="priority" placeholder="优先级[1-10]，越大越优先处理"/>
                                </div>
                            </div>
