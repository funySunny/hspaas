            ...
            <div id="page-content">
                <div class="panel">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">编辑优先级词库</h3>
                    </div>
                    <!-- Panel body -->
                    <form id="myform" class="form-horizontal">
                    	 <input type="hidden" name="smsPriorityWords.id" value="${smsPriorityWords.id!''}">
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-xs-5">
	                              	<select id="userId" name="smsPriorityWords.userId" class="form-control">
					    				...
					    				<#if userList??>
							    			<#list userList as u>
							    				<option value="${u.id!''}" <#if smsPriorityWords.userId==u.id>selected</#if>>${u.name!''}-${u.userName!''}</option>
							    			</#list>
						    			</#if>
					    			</select>
					    		</div>
                           ...
                           <div class="form-group">
                                	 ...
                                	 <select id="status" name="smsPriorityWords.status" class="form-control">
	                                	<#if forbiddenWordsSwitch??>
	                                        <#list forbiddenWordsSwitch as a>
	                                            <option value="${a.value!''}" <#if "${smsPriorityWords.status!''}"==a.value>selected</#if>>${a.title!''}</option>
	                                        </#list>
	                                    </#if>
	                                 </select>
                                </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-xs-5">
                                    <input type="text" class="form-control validate[required,maxSize[100]]" name="smsPriorityWords.content" id="content" value="${smsPriorityWords.content!''}" placeholder="请输入词库内容"/>
                                </div>
                            </div>
    ...
    function formSubmit(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.result){
                    Boss.alertToCallback('修改先级词库成功！',function(){
