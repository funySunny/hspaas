            ...
            <div id="page-content">
                <div class="panel">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">通道短信模板匹配</h3>
                    </div>
                    <!-- Panel body -->
                    <form id="myform" class="form-horizontal">
                        <input type="hidden" name="id" value="${(smsPassageMessageTemplate.id)!}" />
                            ...
                            <div class="form-group batchContent">
                                ...
                                <div class="col-xs-5">
                                    <textarea class="form-control validate[required,maxSize[1000]]"
                                             id="content"  rows="8"><#if smsPassageMessageTemplate??>${smsPassageMessageTemplate.templateContent!''}</#if></textarea>
                                </div>
                            </div>
                            <div class="form-group batchContent">
...
<script type="text/javascript">
    ...
    function formSubmit() {
        ...
        $.ajax({
            url: '${BASE_PATH}/sms/passage_message_template/matchingSubmit',
            dataType: 'json',
