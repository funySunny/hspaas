            ...
            <div id="page-content">
                <div class="panel">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">通道短信模板添加</h3>
                    </div>
                    <!-- Panel body -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" class="form-control validate[maxSize[100]]"
                                           name="smsPassageMessageTemplate.templateId" id="templateId" placeholder="请输入通道方模板ID" />
                                </div>
                            </div>
                            <div class="form-group batchContent">
                                <label class="col-xs-2 control-label">模板内容</label>
                                <div class="col-xs-6">
                                    <textarea class="form-control validate[required,maxSize[1000]]" name="smsPassageMessageTemplate.templateContent" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    function formSubmit() {
        ...
        $.ajax({
            url: '${BASE_PATH}/sms/passage_message_template/save',
            dataType: 'json',
