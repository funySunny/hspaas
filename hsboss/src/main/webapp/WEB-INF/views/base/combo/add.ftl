...
<html lang="en">
                                ...
                                <form id="myform" class="form-horizontal">
                                  <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-5">
                                            <input type="text" class="form-control validate[required,maxSize[100]]" name="combo.name" id="name" placeholder="请输入套餐名称">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                         	<ul id="selectProductDiv" style="display:none" class="primary tagit ui-widget ui-widget-content ui-corner-all">
                                               
                                             </ul>
                                        </div>
                                        <input type="hidden" value="" name="productIds" id="productIds" />
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label">原价</label>
                                        <div class="col-xs-5">
                                            <input type="text" class="form-control validate[required,maxSize[100],custom[number]]" name="originalMoney" id="originalMoney" value="" placeholder="请输入套餐原价">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label">售价</label>
                                        <div class="col-xs-5">
                                            <input type="text" class="form-control validate[required,maxSize[100],custom[number]]" name="sellMoney" id="sellMoney" placeholder="请输入套餐售价">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-5">
                                             <label class="form-radio form-icon"><input type="radio" class="sellTime" id="type_1" name="sellTime" checked value="0">长期有效</label>&nbsp;&nbsp;
                                             <label class="form-radio form-icon"><input type="radio" class="sellTime" id="type_2" name="sellTime" value="1">选择时间段</label>&nbsp;&nbsp;
                                        </div>
                                        <input type="hidden" name="combo.isInTime" id="isInTime" value="0">
                                    </div>
                                    
                                    <div class="form-group selectTime">
                                        <label class="col-xs-3 control-label">开始时间</label>
                                        <div class="col-xs-5">
                                            <input type="text" class="form-control" name="combo.startTime" readonly onClick="WdatePicker()" id="startTime" placeholder="选择开始时间">
                                        </div>
                                    </div>
                                    <div class="form-group selectTime">
                                        <label class="col-xs-3 control-label">截至时间</label>
                                        <div class="col-xs-5">
                                            <input type="text" class="form-control" name="combo.endTime" readonly onClick="WdatePicker()" id="endTime" placeholder="选择结束时间">
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-xs-3 control-label">描述</label>
                                        <div class="col-xs-5">
                                             <textarea class="form-control" name="combo.description" id="description" rows="8"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-3 control-label">备注</label>
                                        <div class="col-xs-5">
                                             <textarea class="form-control" name="combo.remark" id="remark" rows="8"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
	...
	<script type="text/javascript">
		...
		function formSubmit(){
			...
			$.ajax({
	  			url:'${BASE_PATH}/base/combo/create',
	  			dataType:'json',
	  			data:$('#myform').serialize(),
	  			type:'post',
	  			success:function(data){
	  				if(data.result){
                        Boss.alertToCallback('新增套餐成功！',function(){
