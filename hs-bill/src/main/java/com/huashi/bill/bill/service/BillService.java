...
//	private IUserSmsConfigService userSmsConfigService;
    ...
    public FluxDiscountModel getFluxDiscountPrice(int userId, String packages, String mobile) {
        ...
        return new FluxDiscountModel(product.getId(), product.getName(), product.getOfficialPrice(), product.getOutPriceOff());
    }
    ...
    @Override
    public void updateConsumptionReport(int platform) {
